...
do
    echo ""
    echo "===== 4p4d_read_70B_c${C}_metrics ====="

    python3 - <<EOF_PY
import json

p = r"${ROOT_DIR}/results/4p4d_read_70B_c${C}_metrics.json"
...
print("prefill_metrics_url:", pd_tok.get("prefill_metrics_url"))
print("decode_metrics_url:", pd_tok.get("decode_metrics_url"))

print("prefill_prompt_tokens_total:", fmt_unit(pd_tok.get("prefill_prompt_tokens_total"), "tokens", 0))
print("prefill_generation_tokens_total:", fmt_unit(pd_tok.get("prefill_generation_tokens_total"), "tokens", 0))
print("decode_prompt_tokens_total:", fmt_unit(pd_tok.get("decode_prompt_tokens_total"), "tokens", 0))
print("decode_generation_tokens_total:", fmt_unit(pd_tok.get("decode_generation_tokens_total"), "tokens", 0))

print("prefill_prompt_token_throughput:", fmt_unit(pd_tok.get("prefill_prompt_tokens_per_second"), "tok/s", 2))
print("prefill_generation_token_throughput:", fmt_unit(pd_tok.get("prefill_generation_tokens_per_second"), "tok/s", 2))
print("decode_prompt_token_throughput:", fmt_unit(pd_tok.get("decode_prompt_tokens_per_second"), "tok/s", 2))
print("decode_generation_token_throughput:", fmt_unit(pd_tok.get("decode_generation_tokens_per_second"), "tok/s", 2))
